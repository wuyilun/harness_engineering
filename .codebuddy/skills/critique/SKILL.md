...
- **Suggested command**: Which command could address this (from: impeccable, shape, polish, audit, critique, arrange, typeset, bolder, distill, delight, harden, normalize, clarify, adapt, animate, colorize, extract, optimize, quieter, overdrive, onboard)

#### Persona Red Flags
> *Consult [personas](reference/personas.md)*

Auto-select 2-3 personas most relevant to this interface type (use the selection table in the reference). If `CODEBUDDY.md` contains a `## Design Context` section from `impeccable teach`, also generate 1-2 project-specific personas from the audience/brand info.
...
- Only recommend commands from: impeccable, shape, polish, audit, critique, arrange, typeset, bolder, distill, delight, harden, normalize, clarify, adapt, animate, colorize, extract, optimize, quieter, overdrive, onboard
